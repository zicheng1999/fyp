      ...
      <div class='col-md-3 sidebar'> 
        ...
        <div class="sidebar-module-container">
          <div class="sidebar-filter"> 
            <!-- ============================================== SIDEBAR CATEGORY ============================================== -->
            <div class="sidebar-widget wow fadeInUp" style="display:none;">
  ...
  @endphp 
   ...
   @foreach($subcategories as $subcategory)
    ...
    @endforeach              
            ...
            <!-- ============================================== COLOR: END ============================================== --> 
            <!-- == ======= COMPARE==== ==== -->
            <div class="sidebar-widget wow fadeInUp outer-top-vs"  style="display:none;">
          ...
          <!----------- Testimonials------------->
            ...
            <div class="home-banner" style="display:none;"> <img src="{{ asset('frontend/assets/images/banners/LHS-banner.jpg') }}" alt="Image"> </div>
          </div>
          <!-- /.sidebar-filter --> 
        </div>
      ...
      <div class='col-md-9'> 
        ...
        <div id="category" class="category-carousel hidden-xs" style="display:none;">
          <div class="item">
