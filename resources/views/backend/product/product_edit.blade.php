	...
	<textarea name="short_descp_en" id="textarea" class="form-control" required placeholder="Textarea text">
		{!! $products->short_descp_en !!}
	     ...
	     <div class="form-group">
			...
			<div class="controls">
	<textarea name="short_descp_cn" id="textarea" class="form-control" required placeholder="Textarea text">
		{!! $products->short_descp_cn !!}
	</textarea>     
	 		 </div>
		</div>
...
<div class="row"> <!-- start 8th row  -->
	...
	<textarea id="editor1" name="long_descp_en" rows="10" cols="80" required="">
		{!! $products->long_descp_en !!}
	     ...
	     <div class="form-group">
			<h5>Long Description Ccnese <span class="text-danger">*</span></h5>
			<div class="controls">
